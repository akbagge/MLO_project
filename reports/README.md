...
Our project successfully developed an image classifier that can accurately classify different varieties of rice. The classifier is able to distinguish between Arborio, Basmati, Ipsala, Jasmine, and Karacadag rice. To create the classifier, we utilized a deep learning model and utilized the PyTorch Images framework to import a pre-trained ResNet50 model and a training script. We obtained a large dataset of rice images from Kaggle.com to train our model. Overall, this project demonstrates the effectiveness of using deep learning techniques to classify images and highlights the importance of utilizing large datasets in training models.
...
![my_image](figures/experiment.png)
...
In total, 2 credits were spend during development. The most expensive service was TODO
